...
pub enum SourceInfoCommand {
    ...
    /// Take a PKGBUILD file and compare the output that would be generated by this binary when
    /// calling `print-srcinfo` with an actual existing `.SRCINFO` file
    #[command()]
    Compare {
        /// Path to the PKGBUILD file.
        #[arg(value_name = "PKGBUILD_PATH", default_value = "./PKGBUILD")]
        ...
        #[arg(value_name = "SRCINFO_PATH", default_value = "./.SRCINFO")]
