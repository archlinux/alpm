...
pub enum Error {
    ...
    #[error("Errors occurred while comparing ALPM-MTREE data to paths in {path:?}\n{errors}")]
    PathValidation {
        /// The directory below which paths are compared to [`Mtree`] data.
        path: PathBuf,
        /// An accumulated string of error messages.
        errors: String,
    },
