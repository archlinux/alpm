...
///
/// Every line has roughly the same structure:
///
/// ```text
...
/// - `= "This is a default"`: The default value for this option. Everything that converts via
...
macro_rules! linting_config {
    ($(
        ...
        impl LintRuleConfiguration {
            ...
            /// alpm-linting and for development tooling.
            ///
            /// ```
