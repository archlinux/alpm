...
///
/// Dependencies are derived from the dynamic section of all ELF files contained in the package,
/// which are compared to the **soname** dependencies encoded in the package's [PKGINFO] data.
///
