...
These examples assume that a soname as follows exists:
...
The command line arguments are like the following:

```plaintext
Usage: alpm-soname [OPTIONS] <COMMAND>

Commands:
  get-provisions    Get the provisions of a package
  get-dependencies  Get the dependencies of a package
...
You can use these two commands to find the sonames provided by a package and the sonames required by a package.
