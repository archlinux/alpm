...
#[rstest]
#[case::pkginfov1_all_fields_with_env(
    PkgInfoInput {
...
#[case::pkginfov1_optional_fields_with_env(
    PkgInfoInput {
        pkgname: Some("example".to_string()),
        pkgbase: Some("example".to_string()),
        pkgver: Some("1:1.0.0-1".to_string()),
...
#[case::pkginfov1_all_fields_with_cli(
    PkgInfoInput {
        pkgname: Some("example".to_string()),
        pkgbase: Some("example".to_string()),
        pkgver: Some("1:1.0.0-1".to_string()),
...
#[case::pkginfov2_all_fields_with_env(
    PkgInfoInput {
        pkgname: Some("example".to_string()),
        pkgbase: Some("example".to_string()),
        pkgver: Some("1:1.0.0-1".to_string()),
...
#[case::pkginfov2_optional_fields_with_env(
    PkgInfoInput {
        pkgname: Some("example".to_string()),
        pkgbase: Some("example".to_string()),
        pkgver: Some("1:1.0.0-1".to_string()),
...
fn write_pkginfo(
    #[case] pkginfo_input: PkgInfoInput,
