...
impl SourceInfo {
    ...
    /// 2. If the parsing was successful, a tuple of [`SourceInfo`] and [`SourceInfoErrors`] is
    ///    returned. [`SourceInfoErrors`] wraps all errors and lint/deprecation warnings that're
    ///    encountered while interpreting the SRCINFO file.
    ///
    /// ```rust
...
impl SourceInfoResult {
    ...
    /// auto-correction.
    pub fn unsafe_srcinfo(&self) -> &SourceInfo {
        &self.source_info
    }
