...
To allow packages to rely on **soname** data in the context of an **alpm-package-relation**, it is required to expose it in another **alpm-package-relation** first.
