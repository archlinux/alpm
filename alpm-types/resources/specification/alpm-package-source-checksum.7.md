...
In **PKGBUILD** files a **package source checksum** is defined by adding an entry to one of the following arrays:

- md5sums (exclusively accepts the output of the **MD5** **hash function**, or the special value 'SKIP' as values)
- sha1sums (exclusively accepts the output of the **SHA-1** **hash function**, or the special value 'SKIP' as values)
- sha224sums (exclusively accepts the output of the **SHA-224** **hash function**, or the special value 'SKIP' as values)
- sha256sums (exclusively accepts the output of the **SHA-256** **hash function**, or the special value 'SKIP' as values)
- sha384sums (exclusively accepts the output of the **SHA-384** **hash function**, or the special value 'SKIP' as values)
- sha512sums (exclusively accepts the output of the **SHA-512** **hash function**, or the special value 'SKIP' as values)
- b2sums (exclusively accepts the output of the **BLAKE2** **hash function**, or the special value 'SKIP' as values)
...
In **SRCINFO** files a package source checksum is defined using one of the following keyword definitions:

- md5sums (exclusively accepts the output of the **MD5** **hash function**, or the special value 'SKIP' as value)
- sha1sums (exclusively accepts the output of the **SHA-1** **hash function**, or the special value 'SKIP' as value)
- sha224sums (exclusively accepts the output of the **SHA-224** **hash function**, or the special value 'SKIP' as value)
- sha256sums (exclusively accepts the output of the **SHA-256** **hash function**, or the special value 'SKIP' as value)
- sha384sums (exclusively accepts the output of the **SHA-384** **hash function**, or the special value 'SKIP' as value)
- sha512sums (exclusively accepts the output of the **SHA-512** **hash function**, or the special value 'SKIP' as value)
- b2sums (exclusively accepts the output of the **BLAKE2** **hash function**, or the special value 'SKIP' as value)
...
The following **SRCINFO** is generated from it:
...
The above **PKGBUILD** example defines a **package source** setup in which two remote sources are verified using a **SHA-512** and a **BLAKE2** hash each.
