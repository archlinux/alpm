...
impl VersionRequirement {
    ...
    /// Checks whether another [`VersionRequirement`] satisfies this one.
    ///
    /// ## Examples
    ///
    /// ```
    ...
    /// assert!(requirement.is_satisfied_by_requirement(&"<1".parse()?));
    /// assert!(requirement.is_satisfied_by_requirement(&"<=1".parse()?));
    /// assert!(requirement.is_satisfied_by_requirement(&"=0.1".parse()?));
    /// assert!(requirement.is_satisfied_by_requirement(&">0.1".parse()?));
    /// assert!(requirement.is_satisfied_by_requirement(&">=0.1".parse()?));
    /// assert!(requirement.is_satisfied_by_requirement(&"<2".parse()?));
    /// assert!(requirement.is_satisfied_by_requirement(&"<=2".parse()?));
    /// assert!(!requirement.is_satisfied_by_requirement(&"=1".parse()?));
    /// assert!(!requirement.is_satisfied_by_requirement(&">1".parse()?));
    ///
    ...
    /// # }
    /// ```
    pub fn is_satisfied_by_requirement(&self, other: &VersionRequirement) -> bool {
...
mod tests {
    ...
    fn version_requirement_is_satisfied_by_requirement_true(
        #[case] requirement: TestResult<VersionRequirement>,
        #[case] other: VersionRequirement,
    ) -> TestResult {
        assert!(requirement?.is_satisfied_by_requirement(&other));
        Ok(())
    }
    ...
    fn version_requirement_is_satisfied_by_requirement_false(
        #[case] requirement: TestResult<VersionRequirement>,
        #[case] other: VersionRequirement,
    ) -> TestResult {
        assert!(!requirement?.is_satisfied_by_requirement(&other));
