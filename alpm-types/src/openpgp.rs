...
impl Packager {
    ...
    /// # Errors
    ///
    /// Returns an error if `input` is not a valid _packager_.
...
mod tests {
    ...
    #[rstest]
    #[case("<foobar@mcfooface.org>", "invalid packager name")]
    #[case(
    ...
    #[case("Foobar McFooface <@mcfooface.org>", "Local part is empty")]
