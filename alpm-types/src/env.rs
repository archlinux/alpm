...
impl InstalledPackage {
    ...
    /// Recognizes a [`InstalledPackage`] in a string slice.
    ///
    ...
    ///
    /// # fn main() -> Result<(), alpm_types::Error> {
    /// let version_string = "example-package-1:1.0.0-1-x86_64";
    /// assert_eq!(
    ///     version_string,
    ///     InstalledPackage::parser.parse(version_string)?.to_string()
    /// );
    /// # Ok(())
    /// # }
    /// ```
...
impl FromStr for InstalledPackage {
    ...
    /// Creates a [`InstalledPackage`] from a string slice.
    ///
...
mod tests {
    ...
    #[case(
        ...
        InstalledPackage {
            ...
            version: FullVersion::from_str("1:1.0.0-1").unwrap(),
    ...
    #[case(
        ...
        InstalledPackage {
            name: Name::new("foobar").unwrap(),
            version: FullVersion::from_str("1.0.0-1").unwrap(),
            architecture: Architecture::X86_64,
        },
    )]
    fn installed_from_str(#[case] s: &str, #[case] result: InstalledPackage) {
