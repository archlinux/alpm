...
- Disable SBOM generation for python-alpm

## [0.4.2] - 2026-03-17

### Fixed

- Add missing `PackageOption::PEStrip`

### Other

- *(deps)* Update dependency ruff to >=0.15,<0.16
- *(deps)* Update Rust crate pyo3 to 0.28

## [0.4.1] - 2026-01-11

### Fixed

- Return ELF architecture for unversioned SonameV1
- Set proper discriminants for `ElfArchitectureFormat`
