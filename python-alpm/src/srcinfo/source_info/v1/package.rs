...
use crate::{
    helpers::{btree_convert, impl_from, vec_convert},
    types::{
        env::MakepkgOption,
        license::License,
        path::RelativePath,
...
/// Implements `TryFrom<Override> for alpm_srcinfo_package::Override<T>` for various `T`.
/// This is fallible because we can't know the type T passed from Python at compile time.
