...
impl MergedPackage {
    ...
    fn merge_package(&mut self, package: Package) {
        self.0.merge_package(&package.into())
    }

    fn merge_architecture_properties(&mut self, architecture: PackageBaseArchitecture) {
        self.0.merge_architecture_properties(&architecture.into())
    }
