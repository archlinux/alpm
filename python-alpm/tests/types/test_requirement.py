...
def test_version_requirement_init():
...
def test_version_requirement_from_str_valid(req_str):
...
def test_version_requirement_from_str_invalid(invalid_req):
...
def test_version_requirement_with_complex_version():
...
def test_version_requirement_all_comparisons(comparison_type):
