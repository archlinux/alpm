...
def test_checksum_valid(checksum_type, valid_hash: str):
    """Test creating a valid checksum."""
    md5_hash = "d41d8cd98f00b204e9800998ecf8427e"
    checksum = alpm_types.Md5Checksum(md5_hash)
    assert str(checksum) == md5_hash
...
def test_checksum_invalid(checksum_type):
