...
def test_license_valid(license_str: str):
...
@pytest.mark.parametrize("license_str", ["MIT", "Apache-2.0", "Apache-2.0 OR MIT"])
def test_spdx_license_valid(license_str: str):
