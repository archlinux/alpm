...
class Package:
    ...
    def install(self) -> Optional[Override[RelativePath]]:
        """Override of path to an install script of the package."""
    ...
    def architectures(self) -> Optional[list[Architecture]]:
        ...
        Despite being overridable, architectures field isn't of the
        Optional[Override[list[Architecture]]] type, as it **cannot** be cleared.
        """
