...
impl<'a, 'c> Iterator for PackageEntryIterator<'a, 'c> {
...
impl<'a, 'c> Iterator for MetadataEntryIterator<'a, 'c> {
...
impl<'c> Debug for PackageReader<'c> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
impl<'c> TryFrom<Package> for PackageReader<'c> {
    type Error = crate::Error;
...
impl<'c> TryFrom<&Path> for PackageReader<'c> {
    type Error = crate::Error;
