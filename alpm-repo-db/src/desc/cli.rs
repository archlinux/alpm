...
use alpm_types::{Architecture, BuildDate, CompressedSize, ExtraDataEntry, Group, InstalledSize, License, Md5Checksum, Name, OpenPGPSignature, OptionalDependency, PackageBaseName, PackageDescription, PackageFileName, PackageInstallReason, PackageRelation, PackageValidation, Packager, Sha256Checksum, Url, Version};
...
pub enum CreateCommand {
    ...
    V1 {
        ...
        /// The OpenPGP signature of the package file.
        #[arg(env = "ALPM_REPO_DESC_PGPSIG", long)]
        pgpsig: OpenPGPSignature,
    },
    ...
    V2 {
        ...
        /// The OpenPGP signature of the package file.
        #[arg(env = "ALPM_REPO_DESC_PGPSIG", long)]
        pgpsig: Option<OpenPGPSignature>,
    },
}
