...
2. Resource Gathering - Parsing and loading of relevant data files.
3. Lint Rule Selection - Filters available rules based on scope, CLI options and configuration.
4. Execution - Runs selected lints and collects issues
5. Output - Formats and displays results
