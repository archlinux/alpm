...
pub trait LintRule {
    ...
    /// Return the full documentation of this lint rule, including:
    /// - What this rule does
    /// - Reasoning on why this rule exists
    /// - An example
    ///
    /// Use the `documented` crate to simply pass through the struct doc-block that implements this
    /// trait.
    ///
    /// E.g.
    /// ```rs,ignore
