...
pub enum CheckOutputFormat {
    /// Human readable and formatted output.
    #[default]
...
/// Output format for the `rules` and `options` subcommand.
#[derive(Clone, Debug, Default, Display, ValueEnum)]
...
pub enum Command {
    ...
    Check {
        ...
        #[arg(
            short,
            long,
            value_name = "CHECK_OUTPUT_FORMAT",
            default_value_t = CheckOutputFormat::Text
        )]
