...
/// Various types of lint issues may be encountered depending on the file type or current lint
/// scope. This enum is used to categorize found lint issues with the goal to provide detailed data
/// and good error messages for each type of issue.
#[derive(Clone, Debug, Deserialize, Serialize)]
