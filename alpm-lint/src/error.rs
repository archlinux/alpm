...
pub enum Error {
    ...
    /// The wrong type of path was provided for a given scope.
    ///
    /// Example:
    ///
    ...
    InvalidResources {
        /// The [`LintScope`] that was encountered.
        scope: LintScope,
        /// The lint rule that produced this error.
        /// Use to complete the sentence:
        /// `Invalid resources of scope '{scope}' provided to lint rule '{lint_rule}'`.
        lint_rule: String,
        /// The type of [`LintScope`] that was expected.
        /// Used to complete the sentence `Expected resources for {expected}`.
        expected: LintScope,
    },
