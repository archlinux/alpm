...
pub fn rules(
    ...
    let content = serialize_output(lint_rules, output_format, pretty)?;
...
pub fn options(
    ...
    let content = serialize_output(options, output_format, pretty)?;
...
pub fn meta(
    ...
    let meta = Meta::new();
    let content = serialize_output(meta, output_format, pretty)?;
