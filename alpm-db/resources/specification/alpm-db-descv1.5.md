...
The `md5` `sha256` and `pgp` values can be used in combination to indicate that all of them apply (e.g. a package may be validated with both a SHA-256 hash digest and a detached **OpenPGP signature**).
