...
impl Named for DbDescFileV2 {
    fn get_name(&self) -> &Name {
        &self.name
    }
}

impl Versioned for DbDescFileV2 {
    fn get_version(&self) -> &FullVersion {
        &self.version
    }
}

impl RuntimeRelations for DbDescFileV2 {
...
impl Installed for DbDescFileV2 {
