...
- `desc` which provides functionality for writing and parsing of [alpm-db-desc] files.
...
which can be used to create, parse, format and validate ALPM [alpm-db-desc] files.
